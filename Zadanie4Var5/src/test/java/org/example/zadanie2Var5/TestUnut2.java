...
class TestUnut2 {
    ...
    void testTracksInAlbum() {
        ...
        assertTrue(tracks.stream().anyMatch(t -> t.getTitle().equals("Bohemian Rhapsody")));
        assertTrue(tracks.stream().anyMatch(t -> t.getTitle().equals("Thriller")));
    }
